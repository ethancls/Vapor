...
export const api = {
  ...
  getContainerCommands: () => request('GET', '/container/commands'),
  runContainerCommand: (body) => request('POST', '/container/commands', body),
  getContainerCommandHelp: (command) => request('GET', `/container/commands/${encodeURIComponent(command).replaceAll('%20', '/')}/help`),
